...
/* --------------------------------------------------------------------------*/
/**
 * @Synopsis  Rotate a 32 bit integer by n bytes
 *
 * @Param x
 * @Param n
 *
...
/* --------------------------------------------------------------------------*/
/**
 * @Synopsis  Transform the message X which consists of 16 32-bit-words
 *
 * @Param hd
 * @Param data
 */
...
/* --------------------------------------------------------------------------*/
/**
 * @Synopsis  Update the message digest with the contents
